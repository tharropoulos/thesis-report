...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.9\textwidth]{copilotchat screen.png}
    \label{fig:cpchat}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.9\textwidth]{codeComp.png}
    \label{fig:codeComp}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.9\textwidth]{copilot.png}
    \label{fig:codeGen}
...
\begin{figure}[H]
  \begin{center}
    \includegraphics[width=0.9\textwidth]{reference.png}
    \label{fig:reference}
    \caption{Παράδειγμα Δημιουργίας Κώδικα σε πραγματικό χρόνo
      \textlatin{(real time code generation)} εντός του \textlatin{IDE}
      \textlatin{Visual Studio Code} από το \textlatin{GitHub Copilot }
...
Η παρούσα διπλωματική εργασία εστιάζει στην αξιολόγηση της ποιότητας του κώδικα που παράγεται από Μεγάλα Γλωσσικά Μοντέλα, με έμφαση στο \tl{GitHub Copilot}, και στη βελτιστοποίηση των προτροπών. Οι κύριοι στόχοι περιλαμβάνουν:
